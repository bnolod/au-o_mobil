    ...
    return (
        ...
        <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
            ...
            <Button variant="highlight" type="fill" onPress={() => {logout!()}}>
                ...
                <PostCard author_nickname={"teszt"} author_username={"teszti"} comments={[]} date={"2021-01-01"} description={"teszt"} image={{}} location={{lat: 30, lng: 30}} reactions={{fire: 4, heart: 0, sunglasses: 4}}/>
         </View>
