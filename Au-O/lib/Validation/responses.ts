...
export const nickname = {
  invalidLength: {
    HU: 'A becenévnek legalább 3 és maximum 24 karakterből kell állnia.',
    EN: 'Nickname must be 3-24 characters long.',
  },
  noAlphanumeric: {
    HU: 'A becenévnek tartalmaznia kell legalább egy alfanumerikus karaktert.',
    EN: 'Nickname must contain at least one alphanumeric character.',
  },
};
