...
export default function MessageBar({ user, onSend }: MessageBarProps) {
  return (
    <View className="flex flex-row w-11/12 mx-auto gap-2 items-center">
      <TextInput className="basis-10/12 secondary text-black dark:text-white p-6 rounded-xl" placeholder="Type a message..." />
      <Button
        onPress={onSend}
