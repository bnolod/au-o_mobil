...
//     const [selectedEvent, setSelectedEvent] = useState<SocialEvent | null>(
//         null
//     );
...
//             const res = await createImageForm(
//                 image,
...
//                 Toast.show({
//                     type: "success",
//                     text1: PostCreationTexts.imageUploadSuccessToast.header[
//                         language
//                     ],
//                     text2: PostCreationTexts.imageUploadSuccessToast.message[
//                         language
//                     ],
//                 });
//                 setImages([]);
...
//                                 <ImageNotFound
//                                     onPress={async () => {
//                                         const res = await handleGallery(
//                                             images,
//                                             language
//                                         );
//                                         setImages(
//                                             (res as ImagePicker.ImagePickerAsset[]) ||
//                                                 []
//                                         );
//                                     }}
//                                     language={language}
...
//                                 <Input
//                                     label={
//                                         PostCreationTexts.form.description
//                                             .label[language]
//                                     }
//                                     icon="pencil"
//                                     size={28}
...
//                                 <Input
//                                     label={
//                                         PostCreationTexts.form.location.label[
//                                             language
//                                         ]
//                                     }
...
//                                     TextInputProps={{
//                                         placeholder:
//                                             PostCreationTexts.form.location
//                                                 .placeholder[language],
//                                         onChangeText: (text) => {
//                                             setNewPostForm({
//                                                 ...newPostForm,
...
//                                     >
//                                         {
//                                             PostCreationTexts.buttons.dismiss[
//                                                 language
//                                             ]
//                                         }
//                                     </Button>
...
//                                     >
//                                         {
//                                             PostCreationTexts.buttons.post[
//                                                 language
//                                             ]
//                                         }
//                                     </Button>
